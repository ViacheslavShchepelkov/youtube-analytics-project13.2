...
class Channel(MixinAPI):
    ...
    def __init__(self, channel_id: str) -> None:
        ...
        self.number_of_subscribers = selfselfselfself.channel['items'][0]['statistics']['subscriberCount']
        self.video_countvideo_count = selfself.channel['items'][0]['statistics']['videoCount']
